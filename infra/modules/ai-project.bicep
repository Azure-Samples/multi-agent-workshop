...
@description('Optional. Specifies the public network access for the machine learning workspace. Defaults to Enabled.')
@allowed([
  'Enabled'
  'Disabled'
])
...
@description('Optional. The name of logs that will be streamed. Defaults to no logs.')
@allowed([
